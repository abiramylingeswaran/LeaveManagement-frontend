          ...
          <div className="modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 440 }}>
            ...
            <form onSubmit={handleAdd}>
              <div className="field">
                ...
                <input className="input" value={form.name} onChange={update("name")} placeholder="e.g. Nadeesha Perera" required />
              </div>
              ...
              <div className="form-row">
                ...
                <div className="field">
                  ...
                  <input className="input" value={form.designation} onChange={update("designation")} placeholder="e.g. QA Analyst" required />
                </div>
              </div>
              ...
              <div className="form-row">
                <div className="field">
                  ...
                  <input className="input" value={form.manager} onChange={update("manager")} placeholder="Optional" />
                </div>
                <div className="field">
                  <label>Status</label>
